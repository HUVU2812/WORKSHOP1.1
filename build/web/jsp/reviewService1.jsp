...
<html>
	...
	<div class="review-service-container">
		...
		<input type="hidden" name="action" value="ReviewService1">
		<div class="form-group1">
		    <label for="serviceID" style="color: white; font-size: 20px">Select Service:</label>
		    <select name="serviceID" required>
			<%
			    List<Service> services1 = (List<Service>) request.getAttribute("services1");
			    if (services1 != null) {
				for (Service service1 : services1) {
			%>
			<option value="<%= service1.getServiceID()%>"><%= service1.getServiceName()%></option>
			<%
				}
			    }
			%>
