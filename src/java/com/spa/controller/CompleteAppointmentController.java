...
public class CompleteAppointmentController extends HttpServlet {
	...
	String appointmentID = request.getParameter("appointmentID");
        ...
        try {
            ...
            boolean success = dao.completeAppointment(appointmentID);

            if (success) {
                response.sendRedirect(request.getContextPath() + "/MainController?action=ViewConsultation"); // Load lại danh sách
            } else {
